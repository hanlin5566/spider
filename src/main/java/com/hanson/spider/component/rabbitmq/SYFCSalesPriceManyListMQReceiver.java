...
@Component
@RabbitListener(queues = "syfcSalesPriceManyList")
public class SYFCSalesPriceManyListMQReceiver {
	Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	SYFCSalesPriceManyListSpiderService service;
    ...
    public void process(JSONObject msg,Channel channel, Message message) {
    	try {
            ...
            logger.error("SYFCSalesPriceManyListMQReceiver receiver fail",e);
        }
    }
