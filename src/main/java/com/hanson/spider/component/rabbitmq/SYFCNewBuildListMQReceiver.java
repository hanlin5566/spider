...
@Component
@RabbitListener(queues = "syfcNewBuildList")
public class SYFCNewBuildListMQReceiver {
	Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	SYFCNewBuildListSpiderService service;
    ...
    public void process(JSONObject msg,Channel channel, Message message) {
    	try {
            ...
            logger.error("SYFCNewBuildListMQReceiver receiver fail",e);
        }
    }
