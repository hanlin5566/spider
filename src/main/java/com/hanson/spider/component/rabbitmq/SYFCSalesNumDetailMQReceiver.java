...
@Component
@RabbitListener(queues = "syfcSalesNumDetail")
public class SYFCSalesNumDetailMQReceiver {
	Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	SYFCSalesNumDetailSpiderService service;
    ...
    public void process(JSONObject msg,Channel channel, Message message) {
    	try {
            ...
            logger.error("SYFCSalesNumDetailMQReceiver receiver fail",e);
        }
    }
